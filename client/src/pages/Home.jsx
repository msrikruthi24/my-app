  ...
  return (
    <div className="p-10 text-center">
      ...
      <div className="space-x-4">
        <Link to="/teach" className="bg-green-600 text-white px-4 py-2 rounded">Teach</Link>
        <Link to="/learn" className="bg-indigo-600 text-white px-4 py-2 rounded">Learn</Link>
